...
ExperimentalButton::ExperimentalButton(QWidget *parent) : experimental_mode(false), engageable(false), QPushButton(parent) {
  ...
  engage_img = loadPixmap("../assets/img_chffr_wheel.png", {get_d_sm(img_size), get_d_sm(img_size)});
  experimental_img = loadPixmap("../assets/img_experimental.svg", {get_d_sm(img_size), get_d_sm(img_size)});
